...
export async function sendAnalyticsPurgeEmail(csvContent: string) {
  ...
  const mailOptions = {
    ...
    to: adminEmail,
    subject: '?? Respaldo de Anal�ticas - Purgado Autom�tico',
    html: \
  ...
  try {
    ...
    console.log('?? Backup de anal�ticas enviado:', info.messageId);
    ...
    console.error('? Error enviando backup de anal�ticas:', error);
    return false;
  }
}
