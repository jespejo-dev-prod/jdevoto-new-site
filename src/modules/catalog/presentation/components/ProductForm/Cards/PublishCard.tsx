...
export function PublishCard({ isSubmitting, isEditing = false }: PublishCardProps) {
  ...
  return (
    <div className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6 space-y-6 shadow-xl">
      <h3 className="text-xs font-bold text-white uppercase tracking-widest border-b border-zinc-800 pb-4">
      ...
      <div className="space-y-3.5 text-xs font-medium">
        <div className="flex justify-between items-center">
          ...
          <select
            ...
            className="bg-zinc-950 border border-zinc-800 text-primary font-bold rounded-lg px-2.5 py-1 text-[11px] outline-none cursor-pointer focus:border-primary transition-all shadow-inner"
          >
