...
export default function ExportStockPage() {
  ...
  return (
    <RoleGuard allowedRoles={[UserRole.ADMIN]}>
      <div className="p-8 space-y-8 max-w-6xl mx-auto w-full animate-in fade-in duration-300">
          ...
          {activeTab === 'select' && (
            <div className="space-y-6">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                {selectedSkus.size > 0 && (
                  <div className="flex items-center gap-3 bg-zinc-950/60 border border-zinc-800 px-4 py-2.5 rounded-2xl animate-in zoom-in-95 duration-200">
