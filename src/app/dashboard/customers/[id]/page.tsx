  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center py-24 gap-4">
        ...
        <p className="text-zinc-500 font-bold uppercase tracking-widest text-[10px]">Cargando expediente del cliente...</p>
      </div>
    );
  }
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-1">
              <span className="text-zinc-500 font-mono text-sm">{customer.rut}</span>
