...
export const GET = withApiHandler(async (req: NextRequest) => {
  ...
  // Solo ADMIN, SUPER_ADMIN, SALES_REP y VIEWER pueden ver analítica global
  if (user.role !== UserRole.ADMIN && user.role !== UserRole.SUPER_ADMIN && user.role !== UserRole.SALES_REP && user.role !== 'VIEWER') {
