...
export default function SupportPage() {
  ...
  const faqs: FAQ[] = [
    ...
    },
    {
      ...
      a: "Ofrecemos descuento adicional sobre el subtotal neto de tu pedido para la condición de pago al Contado (0 días). Los plazos de pago diferidos (30, 60 y 90 días) corresponden a condiciones de crédito estándar y no acumulan descuentos adicionales.",
    },
    {
      category: "credito",
    ...
    },
    {
      ...
      a: 'Sí, en JDevoto.cl nos especializamos en ventas al por mayor para abastecer al comercio, especialmente librerías y negocios en general. Al agregar productos al carrito, puedes seleccionar la opción "Solicitar Cotización" para recibir un descuento por volumen.',
    },
    {
      category: "credito",
      categoryName: "Finanzas y Crédito",
  ...
  const handleEmailSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          resData.error?.message || "Error al enviar el ticket de soporte",
        );
      }
      ...
      setSubmitError(
        err.message || "No se pudo enviar tu mensaje. Intenta nuevamente.",
      );
    } finally {
      setSubmitting(false);
    }
          ...
          {filteredFaqs.map((faq, index) => {
            ...
            return (
              <div key={faq.q} className="overflow-hidden">
                ...
                >
                  <div>
                    <span className="text-[10px] text-sky-600 font-bold uppercase tracking-wider block mb-1">
                      {faq.categoryName}
                    </span>
                    <span className="text-sm md:text-base font-bold text-zinc-900 pr-4 leading-tight">
                      {faq.q}
                    </span>
                  </div>
                  <ChevronDown
                    className={`h-5 w-5 text-zinc-400 shrink-0 transition-transform duration-300 ${isExpanded ? "rotate-180 text-sky-500" : ""}`}
                  />
                </button>
      ...
      <section className="bg-zinc-100/60 border-t border-b border-zinc-200/80 py-24 px-6 w-full">
        <div className="max-w-[1300px] mx-auto w-full">
          <div className="text-center space-y-3 mb-16">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight text-zinc-900">
              ¿Prefieres Soporte Directo? Contáctanos
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            ...
            <div className="p-8 rounded-[36px] bg-white border border-zinc-200/80 flex flex-col justify-between hover:shadow-lg transition-all duration-300">
              <div className="space-y-6">
                ...
                <p className="text-xs text-zinc-500 leading-relaxed">
                  Escríbenos para resolver dudas de stock, coordinar despachos o
            ...
            <div className="p-8 rounded-[36px] bg-white border border-zinc-200/80 flex flex-col justify-between hover:shadow-lg transition-all duration-300">
              <div className="space-y-6">
                ...
                <p className="text-xs text-zinc-500 leading-relaxed">
                  Envíanos tus órdenes de compra B2B, solicitudes de postventa o
                  dudas comerciales.
                </p>
                <div className="text-xs text-zinc-400 font-medium">
                  contactoweb@jdevoto.cl
                </div>
              </div>
              <a
            ...
            <div className="p-8 rounded-[36px] bg-white border border-zinc-200/80 flex flex-col justify-between hover:shadow-lg transition-all duration-300">
              <div className="space-y-6">
                ...
                <p className="text-xs text-zinc-500 leading-relaxed">
                  Atención telefónica directa en nuestra oficina central
                  corporativa de Placilla (Valparaíso).
                </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 bg-white rounded-[40px] border border-zinc-200/80 p-8 md:p-12 shadow-sm">
            <div className="lg:col-span-5 space-y-6">
              ...
              <h3 className="text-2xl md:text-3xl font-extrabold tracking-tight text-zinc-950">
                Abre una Solicitud de Ayuda
              </h3>
              <p className="text-xs md:text-sm text-zinc-500 leading-relaxed">
                ¿Tienes algún problema con un pedido recibido, necesitas
                solicitar un cambio de mercadería o necesitas cotizar insumos
                para tu oficina de forma mayorista?
              </p>
              <p className="text-xs md:text-sm text-zinc-500 leading-relaxed">
                Completa el formulario a la derecha y nuestro equipo de servicio
                de Placilla responderá a tu solicitud en menos de 24 horas
                hábiles.
              </p>
              ...
              {emailSent ? (
                <div className="h-full flex flex-col items-center justify-center text-center p-8 space-y-4">
                  ...
                  <p className="text-xs text-zinc-500 max-w-sm">
                    Hemos recibido tu requerimiento. Te enviamos un correo de
                    confirmación y un ejecutivo se contactará contigo para
                    coordinar el caso.
                  </p>
                </div>
              ) : (
                ...
                >
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <input
                        ...
                        className={`w-24 bg-white border rounded-xl px-4 py-2.5 outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500/20 text-center font-bold text-sm ${
                          captchaError
                            ? "border-rose-500 ring-1 ring-rose-500/20 text-rose-600"
                    ...
                    {captchaError && (
                      <p className="text-xs font-semibold text-rose-500 mt-1">
                        El resultado es incorrecto. Por favor vuelve a
                        intentarlo.
                      </p>
                    )}
                  </div>
                  ...
                  {submitError && (
                    <p className="text-xs font-semibold text-rose-500 text-center mt-2">
                      {submitError}
                    </p>
                  )}
                </form>
