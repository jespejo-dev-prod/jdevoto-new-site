...
export function PublicFooter() {
  return (
    <footer className="bg-zinc-950 text-white py-16 px-6 sm:px-12 border-t border-zinc-800 mt-auto">
      <div className="max-w-[1400px] mx-auto text-center space-y-12">
        ...
        {/* Links */}
        <div className="flex flex-wrap justify-center gap-x-12 gap-y-4 text-[10px] font-black text-zinc-300 uppercase tracking-[0.4em]">
        ...
        {/* Medios de Pago */}
        <div className="flex flex-col items-center gap-4 pt-4 border-t border-zinc-900/60">
          <span className="text-[10px] font-black text-zinc-550 uppercase tracking-widest">Medios de Pago</span>
          <div className="flex flex-wrap justify-center gap-4">
            {/* Mercado Pago */}
            <div className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl border border-zinc-900 bg-zinc-900/40 text-white font-sans select-none shadow-sm">
              <svg className="h-8 w-8 text-white fill-current" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="text-[10px] uppercase font-black tracking-wider text-zinc-300">Mercado Pago</span>
            </div>

            {/* Transferencia Directa */}
            <div className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl border border-zinc-900 bg-zinc-900/40 text-white font-sans select-none shadow-sm">
              <svg className="h-5 w-5 text-emerald-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                <rect x="2" y="5" width="20" height="14" rx="2" />
                <line x1="2" y1="10" x2="22" y2="10" />
              </svg>
              <span className="text-[10px] uppercase font-black tracking-wider text-zinc-300">Transferencia Directa</span>
            </div>

            {/* Crédito B2B */}
            <div className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl border border-zinc-900 bg-zinc-900/40 text-white font-sans select-none shadow-sm">
              <svg className="h-5 w-5 text-amber-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
                <path d="m9 11 2 2 4-4" />
              </svg>
              <span className="text-[10px] uppercase font-black tracking-wider text-zinc-300">Crédito B2B</span>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1000px] mx-auto pt-6 border-t border-zinc-900/60 text-center space-y-3 text-zinc-500 text-[10px] sm:text-[11px] font-medium leading-relaxed">
          <p>
            Por tu seguridad, recuerda revisar siempre en tu navegador que el sitio que visitas sea la versión oficial. La dirección <span className="text-zinc-400 font-bold">https://www.jdevoto.cl</span> es la única del sitio oficial de Jdevoto.
          </p>
          <p>
            Seguridad y Privacidad Garantizada SSL Secure. Comprar en Jdevoto.cl es 100% seguro.
          </p>
          <p>
            <span className="text-zinc-400 font-bold">COMERCIAL J. DEVOTO LIMITADA</span>, Rut N° <span className="text-zinc-400 font-bold">84.915.400-1</span>, domiciliada en Oriente - Décima Avenida 1740, 2373506 Placilla, Valparaíso. Teléfono: (32) 331 5100.
          </p>
        </div>

        {/* Derechos Reservados */}
        <p className="text-[11px] text-zinc-400 font-bold uppercase tracking-[0.2em] pt-4">
          Derechos reservados Jdevoto © {new Date().getFullYear()}
        </p>
      </div>
    </footer>
  );
