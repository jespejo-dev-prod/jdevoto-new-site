...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 px-5 py-3.5 bg-[#25d366] hover:bg-[#20ba5a] text-white rounded-full font-bold text-sm tracking-wide shadow-lg shadow-emerald-500/20 hover:shadow-xl hover:shadow-emerald-500/30 hover:scale-105 active:scale-95 transition-all duration-300 group border border-emerald-400/20"
      aria-label="Contactar por WhatsApp"
    >
      {/* Icono de WhatsApp SVG Oficial */}
      <svg
        viewBox="0 0 24 24"
        className="h-5 w-5 fill-current transition-transform group-hover:rotate-12 duration-300"
